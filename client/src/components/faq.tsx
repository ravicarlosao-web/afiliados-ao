    ...
    <section id="faq" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 container mx-auto">
      ...
      <div className="max-w-3xl mx-auto">
        <Accordion type="single" collapsible className="space-y-3 sm:space-y-4">
          <AccordionItem value="item-1" className="bg-card border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6">
          ...
          <AccordionItem value="item-2" className="bg-card border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6">
            <AccordionTrigger className="text-base sm:text-lg font-medium hover:no-underline py-4 sm:py-6 text-left">
           ...
           <AccordionItem value="item-3" className="bg-card border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6">
            <AccordionTrigger className="text-base sm:text-lg font-medium hover:no-underline py-4 sm:py-6 text-left">
          ...
          <AccordionItem value="item-4" className="bg-card border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6">
            <AccordionTrigger className="text-base sm:text-lg font-medium hover:no-underline py-4 sm:py-6 text-left">

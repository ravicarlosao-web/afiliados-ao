...
export function Hero() {
  return (
    <section className="pt-28 sm:pt-32 md:pt-40 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 text-center">
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-[1.15] sm:leading-[1.2] font-['DM_Sans'] max-w-5xl mx-auto">
          Comece a ganhar 70.000 Kz por semana vendendo sites sem precisar criar nenhum site!
        </h1>
        
        <p className="text-base sm:text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-['Poppins']">

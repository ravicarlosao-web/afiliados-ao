...
export function Navbar() {
  ...
  return (
    <motion.nav
      ...
      role="navigation"
      aria-label="Navegação principal do Afiliados.ao"
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        >
          ...
          <Link href="/login">
            ...
            >
              <Button className="bg-white text-black hover:bg-zinc-200 rounded-full px-6 font-semibold shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all">
                Cadastrar
              </Button>
            </motion.div>
          </Link>

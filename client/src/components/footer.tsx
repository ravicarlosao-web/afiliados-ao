...
export function Footer() {
  return (
    <footer className="pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 px-4 sm:px-6 container mx-auto relative z-20 border-t border-white/5">
      <div className="bg-card border border-white/10 rounded-2xl sm:rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-10 md:p-16 lg:p-24 text-center mb-12 sm:mb-16 md:mb-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none" />
        <div className="relative z-10 max-w-3xl mx-auto space-y-5 sm:space-y-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-[1.1] font-['DM_Sans']">
      ...
      <div className="flex flex-col gap-8 sm:gap-12 md:flex-row md:justify-between md:items-start text-sm text-zinc-500 pb-8 sm:pb-12">
        <div className="max-w-xs space-y-4">
          ...
          <p className="pt-2 sm:pt-4 text-xs sm:text-sm">© 2026 KYSdigital Todos direitos reservados</p>
        </div>
